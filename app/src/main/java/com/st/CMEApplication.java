...
import com.framework.AApplication;
...
import com.st.db.dao.DaoMaster;
...
import com.st.service.GPSLocationService;
...
public class CMEApplication extends AApplication {
    ...
    private static final String LOG_TAG = CMEApplication.class.getSimpleName();
    ...
    private List<FrmDepartmentEntity> departmentList;
...
//        crashHandler.setLogPath(ProjectPathManager.getInstance(this).getLogPat());
    ...
    public void init(){
        // 初始化文件路径
        ProjectPathManager.getInstance(getApplicationContext()).init();
        //初始化文件路径
        String dbPath = ProjectPathManager.getInstance(this).getDbFilePath()+"/"+ProjectPathManager.DBNAME;
        //创建APP文件夹
        ...
        //初始化GreenDao
        DaoMaster.DevOpenHelper masterHelper = new DaoMaster.DevOpenHelper(getApplicationContext(),dbPath,null);
        mDaoMaster = new DaoMaster(masterHelper.getWritableDb());
    ...
    public DaoSession getDaoSeeion() {
        return mDaoSession;
    }

    public void setDepartmentList(List<FrmDepartmentEntity> departmentList) {
        this.departmentList = departmentList;
    }

    public List<FrmDepartmentEntity> getDepartmentList() {
    ...
    public void setCurrentLocation(GpsData currentLocation) {
    ...
    public static boolean isExternalStorageWritableErrorToast(
        ...
        showMessage(context,R.string.info_no_external_storage);
                ...
                while ((line = br.readLine()) != null)   {
                    ...
                    if ( !line.equals("")
                        ...
                        try {
                            ...
                            showMessage(context, R.string.info_file_to_big);
                    ...
                    .setPositiveButton(R.string.action_replace,
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    // Replace.
                                    if (CMEApplication.saveFile(file, lines, false)) {
                                        showMessage(context, R.string.info_save_successful);
//                                        Toast.makeText(context, R.string.info_save_successful,
//                                                Toast.LENGTH_LONG).show();
                                        activity.onSaveSuccessful();
                                    } else {
                                        showMessage(context, R.string.info_save_error);
...
//                                                Toast.LENGTH_LONG).show();
                    ...
                    .setNeutralButton(R.string.action_append,
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    // Append.
                                    if (CMEApplication.saveFileAppend(file, lines, isDump)) {
                                        showMessage(context, R.string.info_save_successful);
//                                        Toast.makeText(context, R.string.info_save_successful,
//                                                Toast.LENGTH_LONG).show();
                                        activity.onSaveSuccessful();
...
//                        Toast.LENGTH_LONG).show();
    ...
    public static int treatAsNewTag(Intent intent, Context context) {
        ...
        if (NfcAdapter.ACTION_TECH_DISCOVERED.equals(intent.getAction())) {
            ...
            setTagID(byte2HexString(tag.getId()));
//            Toast.makeText(context, id, Toast.LENGTH_SHORT).show();

            showMessage(context,"检测到医通卡！");
     ...
     *
     * 检查设备支持MIFARE经典技术。
     * 为了做到这一点，有一个第一次检查，确保设备实际上有
     * NFC硬件（如果不是，{@链接# museaseditoronly }设置为true）。
     * 在这之后，这个函数将检查是否有文件。
     * / dev / bcm2079x-i2c”或“/系统/图书馆/ Libnfc bcrm *”。文件一样
     * 这些都是博通公司生产的NFC控制器的指标。
     * Broadcom芯片不支持Mifare Classic。
     * @返回true，如果设备支持Mifare Classic。否则为假。
     * 看# mhasmifareclassicsupport
     * 看# museaseditoronly
     */
     ...
     * 创建一个连接{@链接mcreader }如果有现在的Mifare Classic
     * 标签。如果没有Mifare经典标签错误
     * 消息将显示给用户
...
//                Toast.LENGTH_LONG).show();
    ...
    public static boolean isHexAnd16Byte(String hexString, Context context) {
        if (!hexString.matches("[0-9A-Fa-f]+")) {
            // Error, not hex.
            showMessage(context, R.string.info_not_hex_data);
...
//                    Toast.LENGTH_LONG).show();
        ...
        if (hexString.length() != 32) {
            ...
            showMessage(context, R.string.info_not_16_byte);
...
//                    Toast.LENGTH_LONG).show();
    ...
    public static boolean isValueBlock(String hexString) {
        byte[] b = CMEApplication.hexStringToByteArray(hexString);
        if (b.length == 16) {
    ...
    public static void isValidDumpErrorToast(int errorCode,
        ...
        switch (errorCode) {
            case 1:
                showMessage(context, R.string.info_valid_dump_not_4_or_16_lines);
//                Toast.makeText(context, R.string.info_valid_dump_not_4_or_16_lines,
//                        Toast.LENGTH_LONG).show();
                break;
            case 2:
                showMessage(context, R.string.info_valid_dump_not_hex);
//                Toast.makeText(context, R.string.info_valid_dump_not_hex,
//                        Toast.LENGTH_LONG).show();
                break;
            case 3:
                showMessage(context, R.string.info_valid_dump_not_16_bytes);
//                Toast.makeText(context, R.string.info_valid_dump_not_16_bytes,
//                        Toast.LENGTH_LONG).show();
                break;
            case 4:
                showMessage(context, R.string.info_valid_dump_sector_range);
//                Toast.makeText(context, R.string.info_valid_dump_sector_range,
//                        Toast.LENGTH_LONG).show();
                break;
            case 5:
                showMessage(context, R.string.info_valid_dump_double_sector);
//                Toast.makeText(context, R.string.info_valid_dump_double_sector,
//                        Toast.LENGTH_LONG).show();
                break;
            case 6:
                showMessage(context, R.string.info_valid_dump_empty_dump);
...
//                        Toast.LENGTH_LONG).show();
     ...
     * {@link com.st.nfc.activity.KeyMapCreatorActivity}.
     ...
     * The {@link com.st.nfc.activity.KeyMapCreatorActivity} will do
    ...
    public static void showMessage(Context context,String strMsg){
        customToast.showToast(context,strMsg);
//        Toast.makeText(this , strMsg , Toast.LENGTH_SHORT).show();
    ...
    public static void showMessage( Context context,int msgId ){
        ...
        customToast.showToast(context,context.getResources().getString(msgId));
//        Toast.makeText(this , strMsg , Toast.LENGTH_SHORT).show();
    }
