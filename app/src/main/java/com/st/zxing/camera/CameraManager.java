...
import com.st.zxing.camera.open.OpenCameraInterface;
...
public class CameraManager {
	...
	public synchronized void openDriver(SurfaceHolder holder) throws IOException {
		...
		try {
			...
			// Driver failed
			Log.w(TAG, "Camera rejected parameters. SettingActivity only minimal safe-mode parameters");
